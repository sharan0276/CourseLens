...
def main():
    ...
    try:
        if args.file:
            ...
            # Always upload syllabus_topics.json if we are running the setup script
            print("Uploading syllabus_topics.json back to S3...")
            ...
            # S3 path prefix is "CourseLens_data/ppts/" as per slide directory organization
            s3_service.download_folder("CourseLens_data/ppts/", tmp_raw_folder, extensions=['.pptx', '.pdf'])
